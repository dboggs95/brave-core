...
void RewardsDOMHandler::OnGetRewardsParameters(
  ...
  if (parameters) {
    ...
    data.Set("autoContributeChoices", std::move(choices));
  }
...
void RewardsDOMHandler::GetAdsData(const base::Value::List& args) {
  ...
  ads_data.Set("adsPerHour", static_cast<int>(ads_service_->GetAdsPerHour()));
  ...
  ads_data.Set(kNeedsBrowserUpdateToSeeAds,
