...
constexpr webui::LocalizedString kLocalizedStrings[] = {
    ...
    {"braveWalletArticleLinkWhatsTheBestWallet",
     IDS_BRAVE_WALLET_ARTICLE_LINK_WHATS_THE_BEST_WALLET},
    {"braveWalletArticleLinkWhatsACryptoBrowser",
     IDS_BRAVE_WALLET_ARTICLE_LINK_WHATS_A_CRYPTO_BROWSER},
    {"braveWalletArticleLinkWalletsBasics",
     IDS_BRAVE_WALLET_ARTICLE_LINK_WALLETS_BASICS},
    {"braveWalletArticleLinkWhatsARecoveryPhrase",
     IDS_BRAVE_WALLET_ARTICLE_LINK_WHATS_A_RECOVERY_PHRASE},
    {"braveWalletArticleLinkWhatAreDapps",
